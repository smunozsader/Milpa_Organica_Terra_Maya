...
\begin{itemize}
  \item \textbf{Inversión inicial:} \$4,780,000 MXN (20 ha)
  \item \textbf{Retorno de inversión (ROI) a 5 años:} 542.5\%
  \item \textbf{Punto de equilibrio:} Año 1 (flujo de caja positivo inmediato)
...
El sistema se basa en el policultivo tradicional maya (milpa) tecnificado mediante investigación científica del Centro de Investigación Científica de Yucatán (CICY), específicamente el Sistema de Producción Continua de Maíz (SPCM) desarrollado por el Dr. Alfonso Larqué Saavedra y colaboradores.
...
\midrule
Excavación pocetas\footnote{Incluye tolchas perimetrales} & 150,000 & 3,000,000 & 62.8\% \\
Sustrato orgánico & 44,000 & 880,000 & 18.4\% \\
Sistema riego goteo & 45,000 & 900,000 & 18.8\% \\
\midrule
\rowcolor{tmlight}
\textbf{TOTAL} & \textbf{239,000} & \textbf{4,780,000} & \textbf{100\%} \\
\bottomrule
\end{tabular}
\end{table}
...
\textbf{Observaciones:}
\begin{itemize}
  \item Excavación en litosol requiere equipo especializado (\$7/poceta aprox.)
  ...
  \item Subsidios SADER para agricultura tecnificada disponibles (no considerados en análisis conservador)
\end{itemize}
...
\textbf{Prima orgánica:} Frijol certificado obtiene +190\% vs convencional (\$12,000/t); pepita +250\% vs industrializada.
...
\midrule
1 & 209.1 & 78.1 & 24.0 & 6,329,664 & 820,000 & 5,509,664 & 15.3\% \\
2 & 230.0 & 86.0 & 26.4 & 6,962,630 & 820,000 & 6,142,630 & 143.8\% \\
3 & 230.0 & 86.0 & 26.4 & 6,962,630 & 820,000 & 6,142,630 & 272.3\% \\
4 & 240.5 & 89.9 & 27.6 & 7,279,114 & 820,000 & 6,459,114 & 407.4\% \\
5 & 240.5 & 89.9 & 27.6 & 7,279,114 & 820,000 & 6,459,114 & 542.5\% \\
\midrule
\rowcolor{tmlight}
...
\midrule
Inversión inicial & \$4,780,000 MXN \\
Ingresos acumulados (5 años) & \$34,813,152 MXN \\
Costos operativos totales (5 años) & \$8,880,000 MXN\footnote{Incluye inversión inicial} \\
Ganancia neta acumulada & \$25,933,152 MXN \\
\midrule
\rowcolor{tmlight}
\textbf{ROI 5 años} & \textbf{542.5\%} \\
Punto de equilibrio & \textbf{Año 1} \\
TIR estimada\footnote{Tasa Interna de Retorno} & \textbf{$>$120\% anual} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Interpretación:} Cada peso invertido genera \textbf{\$5.43 de ganancia neta} en 5 años, con recuperación total de capital en el primer año productivo.
...
\midrule
Huracanes & Pérdida 1 ciclo ($-$33\% año) & Escalonamiento de siembras, tolchas protectoras \\
\midrule
...
\textbf{Análisis:} La inversión inicial de \$4.78M se recupera completamente en el \textbf{Año 1}, con flujo de caja positivo desde el primer ciclo productivo. La pendiente ascendente demuestra rentabilidad sostenida.
...
\begin{enumerate}
  \item \textbf{Recuperación inmediata:} Inversión inicial recuperada en Año 1 ($<$12 meses operativos)
  \item \textbf{Rentabilidad sostenida:} ROI 542\% a 5 años (promedio 108\%/año)
...
\begin{itemize}
  \item Expandir a 100 ha con capital generado en Año 1
...
\subsection*{B. Referencias Científicas}

\begin{itemize}
  \item Larqué Saavedra, A., et al. (2018). \textit{Sistema de Producción Continua de Maíz en suelos pedregosos de Yucatán}. CICY.
  \item Terra Latinoamericana (2017). \textit{Rendimientos de milpa orgánica en policultivo bajo riego}.
  \item SAGARPA (2023). \textit{Precios de garantía y mercado orgánico certificado, México}.
\end{itemize}
