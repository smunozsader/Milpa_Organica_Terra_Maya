...
\begin{itemize}
  \item \textbf{Inversión en equipo:} \$3,395,000 MXN (2 retroexcavadoras + aditamento FAE)
  \item \textbf{Costo total excavación 20 ha:} \$5,525,000 MXN (equipo + operación 4 años)
...
\section{Consideraciones de Arrendamiento Ejidal y Layout del Proyecto}

\subsection{Contexto de Tenencia de la Tierra}

Según información proporcionada por el Lic. Carlos Sobrino Sierra, los terrenos para el proyecto son \textbf{arrendamientos a largo plazo} con el ejido de Timucuy, Yucatán. Este modelo de tenencia tiene implicaciones directas para la planificación del layout del proyecto, especialmente considerando los requerimientos de tolchés (perímetros de protección) y caminos internos.

\subsection{Impacto del Layout con Tolchés Individuales}

El diseño óptimo del proyecto (detallado en el documento técnico de excavación) incluye tolchés perimetrales de 20 metros alrededor de cada subsección de 5 hectáreas y caminos internos de 6 metros según estándares industriales para maquinaria pesada.

\subsubsection{Requerimientos de Superficie Total}

\begin{table}[h]
\centering
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Concepto} & \textbf{Sin Tolchés} & \textbf{Con Tolchés} & \textbf{Incremento} \\
\midrule
Fase 1 (20 ha productivas) & 20.00 ha & 28.43 ha & +8.43 ha (+42.2\%) \\
Expansión 100 ha productivas & 100.00 ha & 142.15 ha & +42.15 ha (+42.2\%) \\
Expansión 250 ha productivas & 250.00 ha & 355.38 ha & +105.38 ha (+42.2\%) \\
\bottomrule
\end{tabular}
\caption{Requerimientos de Superficie según Escala de Implementación}
\end{table}

\textbf{Distribución de áreas (Fase 1):}
\begin{itemize}
  \item \textbf{Área productiva:} 20.00 ha (70.3\% del total) --- con pocetas, riego, cultivos
  \item \textbf{Tolchés perimetrales:} 7.79 ha (27.4\%) --- vegetación nativa, protección contra fauna
  \item \textbf{Caminos internos:} 0.64 ha (2.2\%) --- acceso para maquinaria (CAT 420F)
  \item \textbf{TOTAL:} 28.43 ha
\end{itemize}

\subsection{Viabilidad del Arrendamiento Ejidal}

\subsubsection{Disponibilidad de Superficie en Timucuy}

\textbf{Análisis de impacto sobre superficie ejidal:}

\begin{itemize}
  \item Superficie ejidal típica de Timucuy: > 3,000 hectáreas
  \item Fase 1 (28.43 ha): \textbf{0.9\% del ejido} → impacto mínimo sobre disponibilidad
  \item Expansión 250 ha productivas (355 ha con tolchés): \textbf{11.8\% del ejido} → viable con planificación adecuada
  \item \textbf{Conclusión:} El incremento del 42.2\% por tolchés y caminos NO representa una restricción significativa para el modelo de arrendamiento
\end{itemize}

\subsubsection{Ventajas del Modelo de Arrendamiento para Infraestructura Perimetral}

\begin{enumerate}
  \item \textbf{Flexibilidad de negociación:}
  \begin{itemize}
    \item Mayor facilidad para obtener bloques contiguos más grandes
    \item Tolchés benefician al ejido (biodiversidad, conservación de suelos, captación pluvial)
    \item Caminos internos pueden tener uso compartido con el ejido
  \end{itemize}

  \item \textbf{Valor agregado para el ejido:}
  \begin{itemize}
    \item Tolchés con vegetación nativa actúan como corredores biológicos
    \item Reducción de erosión en zonas de litosoles (suelos delgados típicos de Yucatán)
    \item Cortafuegos naturales (reducen riesgo de incendios en temporada seca)
    \item Infraestructura permanente (caminos) que mejora accesibilidad ejidal
  \end{itemize}

  \item \textbf{Generación de valor social:}
  \begin{itemize}
    \item Empleo directo: 15-20 trabajadores por cada 20 ha productivas
    \item Transferencia tecnológica: Capacitación en SPCM a ejidatarios interesados
    \item Conservación ambiental compatible con agricultura productiva
  \end{itemize}
\end{enumerate}

\subsection{Estrategia de Negociación y Costos de Arrendamiento}

\subsubsection{Propuesta de Renta}

\textbf{Opciones de negociación:}

\begin{table}[h]
\centering
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Esquema} & \textbf{Superficie} & \textbf{Renta/ha/año} & \textbf{Costo Anual} \\
\midrule
A: Renta solo área productiva & 20.00 ha & \$3,000 & \$60,000 \\
B: Renta total (sin diferencial) & 28.43 ha & \$3,000 & \$85,290 \\
C: Renta diferenciada & 20 ha + 8.43 ha & \$3,000 + \$1,500 & \$72,645 \\
\bottomrule
\end{tabular}
\caption{Escenarios de Arrendamiento para Fase 1 (20 ha productivas)}
\end{table}

\textbf{Justificación para Esquema A o C:}
\begin{itemize}
  \item Tolchés NO son áreas productivas que generen ingresos directos
  \item Proveen servicios ambientales al ejido (biodiversidad, erosión, incendios)
  \item Precedente: Proyectos forestales/conservación no pagan renta sobre áreas de protección
  \item Argumento de valor compartido: Infraestructura perimetral beneficia a ambas partes
\end{itemize}

\textbf{Costo máximo diferencial (Esquema B vs A):} \$25,290/año

\textbf{Beneficios operativos de tolchés:} \$295,000-\$385,000/año (reducción pérdidas fauna + eficiencia hídrica + mejora rendimientos)

\textbf{Ratio costo-beneficio:} 1:12 a 1:15 (cada peso invertido en renta extra genera 12-15 pesos en beneficios)

\subsection{Implicaciones para Diseño del Proyecto}

\subsubsection{Planificación del Layout}

\textbf{Consideraciones clave para el arrendamiento:}

\begin{enumerate}
  \item \textbf{Selección de parcelas:}
  \begin{itemize}
    \item Priorizar bloques contiguos rectangulares o cuadrados
    \item Solicitar al ejido plano de límites parcelarios disponibles
    \item Evitar parcelas fragmentadas (complica implementación de tolchés)
  \end{itemize}

  \item \textbf{Orientación del terreno:}
  \begin{itemize}
    \item Alinear caminos principales con vientos dominantes (este-oeste)
    \item Ubicar entrada en conexión con camino ejidal existente
    \item Considerar pendiente natural para drenaje (caminos con 2\% hacia tolchés)
  \end{itemize}

  \item \textbf{Flexibilidad geométrica:}
  \begin{itemize}
    \item Si terreno no es cuadrado (533 × 533 m ideal), adaptar a rectángulo
    \item Mantener constantes: 20 ha productivas, tolchés 20 m, caminos 6 m
    \item Ajustar geometría de subsecciones según forma del predio
  \end{itemize}
\end{enumerate}

\subsubsection{Sistemas de Riego y Caminos}

\textbf{Integración con infraestructura perimetral:}

\begin{itemize}
  \item \textbf{Red de riego:} Solo 20 ha productivas (tolchés NO requieren riego)
  \item \textbf{Pozos profundos:} Ubicar en intersección de caminos internos (acceso mantenimiento)
  \item \textbf{Tuberías principales:} Correr por caminos de 6 m (zanjas sin afectar tránsito)
  \item \textbf{Drenaje:} Caminos con pendiente hacia tolchés (absorben excedentes)
  \item \textbf{Red eléctrica:} Por caminos internos (ruta clara, sin obstáculos de vegetación)
\end{itemize}

\subsection{Contrato de Arrendamiento: Elementos Críticos}

\subsubsection{Cláusulas Recomendadas}

\begin{enumerate}
  \item \textbf{Plazo y renovación:}
  \begin{itemize}
    \item Arrendamiento inicial: \textbf{10 años} renovables (seguridad para inversión de \$14.5M)
    \item Opción de compra: Evaluar después de 5 años de operación exitosa
    \item Renovación automática: Salvo notificación contraria 12 meses antes
  \end{itemize}

  \item \textbf{Superficie arrendada:}
  \begin{itemize}
    \item Especificar: \textbf{28.43 ha totales} (20 ha productivas + 8.43 ha infraestructura)
    \item Desglosar: Áreas productivas, tolchés, caminos (evitar ambigüedad)
    \item Incluir plano georeferenciado con coordenadas GPS
  \end{itemize}

  \item \textbf{Uso de tolchés y caminos:}
  \begin{itemize}
    \item Definir tolchés como "zonas de protección perimetral con vegetación nativa"
    \item Permitir revegetación natural o siembra de especies nativas
    \item Prohibir uso agrícola/ganadero en tolchés (conservar función de protección)
    \item Caminos: Derecho de paso para maquinaria del proyecto + uso compartido ejidal
  \end{itemize}

  \item \textbf{Renta y escalamiento:}
  \begin{itemize}
    \item Renta base: \$60,000-\$85,000/año según esquema negociado (Tabla arriba)
    \item Incrementos anuales: Indexados a inflación (INPC), NO a productividad
    \item Pago anticipado: Anual o semestral (mejorar flujo de caja del ejido)
  \end{itemize}

  \item \textbf{Cláusula de expansión:}
  \begin{itemize}
    \item Derecho preferente a arrendar parcelas adyacentes (expansión 100-250 ha)
    \item Preaviso: 6 meses antes de requerir nueva superficie
    \item Condiciones: Mismas que contrato original (precio, plazo, términos)
  \end{itemize}

  \item \textbf{Mejoras y devolución:}
  \begin{itemize}
    \item Infraestructura permanente (pozos, caminos, cercas): Quedan para el ejido al término
    \item Suelo mejorado: Compromiso de devolver terreno enriquecido (materia orgánica +50\%)
    \item Instalaciones desmontables (riego por goteo): Propiedad del proyecto
  \end{itemize}

  \item \textbf{Seguros y contingencias:}
  \begin{itemize}
    \item Seguro agrícola: Cubrir eventos climáticos extremos (huracanes, sequías)
    \item Responsabilidad civil: Proteger al ejido de daños a terceros
    \item Fondo de contingencia: 5\% renta anual para imprevistos
  \end{itemize}
\end{enumerate}

\subsection{Planificación de Expansión Futura}

\subsubsection{Modelo Modular Escalable}

\textbf{Ventajas del diseño con tolchés individuales para crecimiento:}

\begin{itemize}
  \item \textbf{Unidad básica replicable:} 28.43 ha (20 ha productivas) es módulo estándar
  \item \textbf{Conexión entre módulos:} Caminos de 6 m actúan como "columna vertebral"
  \item \textbf{Infraestructura compartida:} 
  \begin{itemize}
    \item Pozos: 1 por cada 20 ha productivas (no afecta por tolchés)
    \item Red eléctrica: Por caminos internos (ruta clara)
    \item Almacenes/talleres: En intersecciones de módulos
  \end{itemize}
  \item \textbf{Escalamiento gradual:} Arrendar bloques de 28.43 ha según cronograma (4 años/módulo)
\end{itemize}

\textbf{Proyección de superficie para expansiones:}

\begin{table}[h]
\centering
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Escala} & \textbf{Ha Productivas} & \textbf{Ha Totales} & \textbf{Renta Anual*} \\
\midrule
Fase 1 actual & 20 & 28.43 & \$60,000-\$85,000 \\
Expansión 50 ha & 50 & 71.08 & \$150,000-\$213,000 \\
Expansión 100 ha & 100 & 142.15 & \$300,000-\$426,000 \\
Expansión 250 ha & 250 & 355.38 & \$750,000-\$1,066,000 \\
\bottomrule
\end{tabular}
\caption{Escalamiento de Arrendamiento según Crecimiento del Proyecto}
\end{table}

\textit{*Rango según Esquema A (solo productivas) vs Esquema B (total) a \$3,000/ha/año}

\subsection{Conclusiones sobre Arrendamiento Ejidal}

\textbf{Viabilidad confirmada:}

\begin{enumerate}
  \item El incremento del 42.2\% en superficie por tolchés y caminos \textbf{NO es limitante} para arrendamiento ejidal en Timucuy
  \item Disponibilidad ejidal (>3,000 ha) permite expansión hasta 250 ha productivas (355 ha totales)
  \item Costo adicional de renta máximo: \$25,290/año (vs beneficios \$295k-\$385k/año) = \textbf{ROI 12:1}
\end{enumerate}

\textbf{Estrategia recomendada:}

\begin{itemize}
  \item Negociar Esquema A (renta solo ha productivas) o C (renta diferenciada)
  \item Enfatizar beneficios ambientales de tolchés para el ejido (biodiversidad, erosión, cortafuegos)
  \item Contrato 10 años con opción de compra y cláusula de expansión
  \item Presentar proyecto en asamblea ejidal con diagrama de layout y beneficios sociales
\end{itemize}

\textbf{Impacto en viabilidad financiera del proyecto:}

Incluso en el escenario más conservador (Esquema B: \$85,290/año), el costo de arrendamiento representa:
\begin{itemize}
  \item \textbf{0.6\% de inversión inicial} (\$85k / \$14.5M)
  \item \textbf{4.7\% de ingresos anuales} (\$85k / \$1.8M proyectado año 5)
  \item \textbf{Recuperable en 3.4 meses} de operación normal
\end{itemize}

\textbf{Conclusión final:} El modelo de arrendamiento ejidal es \textbf{altamente compatible} con el diseño técnico del proyecto (tolchés individuales + caminos 6m) y \textbf{NO compromete} la viabilidad financiera ni la escalabilidad a largo plazo.
