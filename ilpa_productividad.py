...
# Costos iniciales (MXN/ha) - del análisis costo_pocetas.txt
costo_excavacion_ha = 150000
costo_sustrato_ha = 44000
costo_riego_ha = 45000
costo_inicial_total_ha = costo_excavacion_ha + costo_sustrato_ha + costo_riego_ha
...
# Inversión inicial
inversion_inicial = costo_inicial_total_ha * ha_lote
print(f"\nINVERSIÓN INICIAL: ${inversion_inicial:,.0f} MXN")
print(f"  Excavación pocetas: ${costo_excavacion_ha * ha_lote:,.0f}")
