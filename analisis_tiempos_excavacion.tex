...
\usepackage{tikz}
\usepackage{pgfgantt}
\usetikzlibrary{patterns,shapes,arrows,arrows.meta,positioning,babel}
...
\definecolor{tmorange}{RGB}{255,140,0}
...
\subsection{Comparación Visual Integrada: Todas las Estrategias}
...
\gantttitle{\textbf{Comparación de 5 Estrategias para 20 Hectáreas (108 meses = 9 años)}}{108} \\
\gantttitle{Año 1}{12}
\gantttitle{Año 2}{12}
\gantttitle{Año 3}{12}
\gantttitle{Año 4}{12}
...
% Escenario 1: Solo Contratar (3-6 meses)
\ganttgroup[group/.append style={fill=tmred!50}]{\textbf{1. CONTRATAR TODO}}{1}{6} \\
\ganttbar[bar/.append style={fill=tmred!70}]{Excavación contratada}{1}{6} \\
\ganttmilestone[milestone/.append style={fill=tmred}]{Cosecha}{10}
\ganttbar{}{}{}\\

% Escenario 2: 1 Retro Escalonado (96 meses = 8 años)
\ganttgroup[group/.append style={fill=tmyellow!50}]{\textbf{2. 1 RETRO (96 meses)}}{1}{99} \\
\ganttbar[bar/.append style={fill=tmyellow!60}]{Subsección 1}{1}{24} \\
\ganttbar[bar/.append style={fill=tmyellow!60}]{Subsección 2}{25}{49} \\
\ganttbar[bar/.append style={fill=tmyellow!60}]{Subsección 3}{50}{74} \\
\ganttbar[bar/.append style={fill=tmyellow!60}]{Subsección 4}{75}{99} \\
\ganttmilestone[milestone/.append style={fill=tmyellow}]{1ra Cosecha}{29} \\
\ganttmilestone[milestone/.append style={fill=tmyellow}]{20 ha completas}{104}
\ganttbar{}{}{}\\

% Escenario 3: 2 Retros Escalonado (48 meses = 4 años) - RECOMENDADO
\ganttgroup[group/.append style={fill=tmgreen!70}]{\textbf{3. 2 RETROS - ÓPTIMO (48 meses)}}{1}{49} \\
\ganttbar[bar/.append style={fill=tmgreen!80}]{Subsección 1}{1}{12} \\
\ganttbar[bar/.append style={fill=tmgreen!80}]{Subsección 2}{13}{24} \\
\ganttbar[bar/.append style={fill=tmgreen!80}]{Subsección 3}{25}{36} \\
\ganttbar[bar/.append style={fill=tmgreen!80}]{Subsección 4}{37}{49} \\
\ganttmilestone[milestone/.append style={fill=tmgreen}]{1ra Cosecha}{17} \\
\ganttmilestone[milestone/.append style={fill=tmgreen}]{20 ha completas}{53}
\ganttbar{}{}{}\\

% Escenario 4: Híbrido (1 retro + contratar 10 ha) - 24 meses
\ganttgroup[group/.append style={fill=tmblue!50}]{\textbf{4. HÍBRIDO: 1 Retro + Contratar}}{1}{24} \\
\ganttbar[bar/.append style={fill=tmblue!60}]{Excavación propia (10 ha)}{1}{24} \\
\ganttbar[bar/.append style={fill=tmblue!40}]{Excavación contratada (10 ha)}{1}{6} \\
\ganttmilestone[milestone/.append style={fill=tmblue}]{1ra Cosecha}{10} \\
\ganttmilestone[milestone/.append style={fill=tmblue}]{20 ha completas}{28}
\ganttbar{}{}{}\\

% Escenario 5: 4 Retros (24 meses = 2 años)
\ganttgroup[group/.append style={fill=tmorange!50}]{\textbf{5. 4 RETROS (24 meses)}}{1}{24} \\
\ganttbar[bar/.append style={fill=tmorange!60}]{4 subsecciones simultáneas}{1}{12} \\
\ganttbar[bar/.append style={fill=tmorange!60}]{Instalación y siembra}{13}{24} \\
\ganttmilestone[milestone/.append style={fill=tmorange}]{1ra Cosecha}{17} \\
\ganttmilestone[milestone/.append style={fill=tmorange}]{20 ha completas}{28} \\

\end{ganttchart}
\caption{Comparación Temporal de las 5 Estrategias de Implementación para 20 Hectáreas}
\label{fig:gantt_comparativo_integrado}
\end{figure}

\begin{table}[h]
\centering
\caption{Resumen Comparativo de Estrategias}
\begin{tabular}{@{}lcccc@{}}
\toprule
\textbf{Estrategia} & \textbf{Tiempo} & \textbf{1ra Cosecha} & \textbf{Inversión} & \textbf{Costo Total} \\
\midrule
\rowcolor{tmred!20}
1. Solo Contratar & 6 meses & Mes 10 & \$15.51M & \$15.51M \\
\rowcolor{tmyellow!20}
2. 1 Retro Escalonado & 99 meses & Mes 29 & \$1.58M & \$13.57M \\
\rowcolor{tmgreen!30}
\textbf{3. 2 Retros Escalonado} & \textbf{49 meses} & \textbf{Mes 17} & \textbf{\$3.395M} & \textbf{\$15.15M} \\
\rowcolor{tmblue!20}
4. Híbrido & 24 meses & Mes 10 & \$9.35M & \$17.33M \\
\rowcolor{tmorange!20}
5. 4 Retros & 24 meses & Mes 17 & \$10.16M & \$16.73M \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{itemize}
  \item \textbf{Estrategia 3 (2 Retros)} destaca como el balance óptimo entre velocidad y costo
  \item Primera cosecha en \textbf{mes 17} vs mes 29 (estrategia 2) = 12 meses de ventaja
  \item Completa 20 ha en \textbf{49 meses} vs 99 meses (estrategia 2) = 50 meses más rápido
  \item Costo similar a contratar todo (\$15.15M vs \$15.51M) pero con equipos que se reutilizan
  \item Evita sobreinversión de estrategia 5 (4 retros a \$10.16M)
\end{itemize}
...
\newpage
\section{Distribución Espacial: Layout con Tolchés}

\subsection{Consideraciones de Diseño del Terreno}

Según estándares industriales para agricultura mecanizada con maquinaria pesada (retroexcavadoras, tractores), cada implementación de 20 hectáreas productivas requiere:

\begin{itemize}
  \item \textbf{Área productiva por subsección:} 5 hectáreas (223.6 m × 223.6 m)
  \item \textbf{Tolché alrededor de CADA subsección:} 20 metros de ancho (protección contra fauna + cortafuego)
  \item \textbf{Caminos internos entre subsecciones:} 6 metros de ancho (estándar para CAT 420F + tránsito bidireccional)
  \item \textbf{Configuración:} 4 subsecciones en arreglo 2×2 con cruz de caminos
\end{itemize}

\textbf{Justificación ancho de caminos (6 m):}
\begin{itemize}
  \item CAT 420F ancho total: 2.4 m
  \item Tránsito bidireccional: 2 × 2.4 = 4.8 m
  \item Margen de seguridad + cunetas: +1.2 m
  \item \textbf{Total recomendado: 6 m} (estándar industrial)
\end{itemize}

\subsection{Cálculos de Dimensiones}

\textbf{Subsección productiva (núcleo):}
\begin{align*}
\text{Área productiva} &= 50,000\text{ m}^2 \\
\text{Lado del cuadrado} &= \sqrt{50,000} = 223.6\text{ m}
\end{align*}

\textbf{Subsección con tolché (unidad básica):}
\begin{align*}
\text{Lado con tolché} &= 223.6 + (2 \times 20) = 263.6\text{ m} \\
\text{Área unidad} &= 263.6^2 = 69,485\text{ m}^2 = 6.95\text{ ha}
\end{align*}

\textbf{Dimensiones totales del terreno (4 unidades + caminos):}
\begin{align*}
\text{Ancho total} &= (2 \times 263.6) + 6\text{ (camino central)} = \textbf{533.2 m} \\
\text{Alto total} &= (2 \times 263.6) + 6\text{ (camino central)} = \textbf{533.2 m} \\
\text{Área total requerida} &= 533.2^2 = 284,302\text{ m}^2 = \textbf{28.43 ha}
\end{align*}

\textbf{Distribución de áreas:}
\begin{table}[h]
\centering
\caption{Desglose de Superficies para 20 ha Productivas (Diseño con Tolchés Individuales)}
\begin{tabular}{@{}lrrr@{}}
\toprule
\textbf{Componente} & \textbf{Área (ha)} & \textbf{Área (m²)} & \textbf{\% Total} \\
\midrule
4 subsecciones productivas (5 ha c/u) & 20.00 & 200,000 & 70.3\% \\
4 tolchés perimetrales (20 m c/u) & 7.79 & 77,940 & 27.4\% \\
Caminos internos (6 m cruz) & 0.64 & 6,362 & 2.2\% \\
\midrule
\textbf{TOTAL terreno requerido} & \textbf{28.43} & \textbf{284,302} & \textbf{100.0\%} \\
\bottomrule
\end{tabular}
\end{table}

\textbf{Incremento de terreno:} 20 ha productivas requieren \textbf{28.43 ha totales} = \textbf{+42.2\% adicional}

\textbf{Nota:} Este incremento del 42\% es típico en proyectos agrícolas mecanizados con requerimientos de protección contra fauna silvestre. En regiones con menor presión de fauna, se puede reducir el tolché a 10-15 m, disminuyendo el incremento a 25-35\%.

\subsection{Diagrama de Distribución}

\begin{figure}[h]
\centering
\begin{tikzpicture}[scale=0.013]

% Rectángulo total del terreno
\draw[draw=black, line width=2pt] 
  (0,0) rectangle (533.2,533.2);

% SUBSECCIÓN 1 (superior izquierda)
% Tolché subsección 1
\draw[fill=tmgray!30, draw=tmgray, line width=1pt] 
  (0,269.6) rectangle (263.6,533.2);
% Área productiva subsección 1
\draw[fill=tmgreen!40, draw=tmgreen!80, line width=1.5pt] 
  (20,289.6) rectangle (243.6,513.2);
\node[font=\Large\bfseries] at (131.8,420) {SUB 1};
\node[font=\small] at (131.8,405) {5 ha productivas};
\node[font=\small] at (131.8,390) {223.6 × 223.6 m};
\node[font=\tiny, text=tmgray] at (131.8,275) {tolché 20 m};

% SUBSECCIÓN 2 (superior derecha)
% Tolché subsección 2
\draw[fill=tmgray!30, draw=tmgray, line width=1pt] 
  (269.6,269.6) rectangle (533.2,533.2);
% Área productiva subsección 2
\draw[fill=tmgreen!40, draw=tmgreen!80, line width=1.5pt] 
  (289.6,289.6) rectangle (513.2,513.2);
\node[font=\Large\bfseries] at (401.4,420) {SUB 2};
\node[font=\small] at (401.4,405) {5 ha productivas};
\node[font=\small] at (401.4,390) {223.6 × 223.6 m};
\node[font=\tiny, text=tmgray] at (401.4,275) {tolché 20 m};

% SUBSECCIÓN 3 (inferior izquierda)
% Tolché subsección 3
\draw[fill=tmgray!30, draw=tmgray, line width=1pt] 
  (0,0) rectangle (263.6,263.6);
% Área productiva subsección 3
\draw[fill=tmgreen!40, draw=tmgreen!80, line width=1.5pt] 
  (20,20) rectangle (243.6,243.6);
\node[font=\Large\bfseries] at (131.8,150) {SUB 3};
\node[font=\small] at (131.8,135) {5 ha productivas};
\node[font=\small] at (131.8,120) {223.6 × 223.6 m};
\node[font=\tiny, text=tmgray] at (131.8,255) {tolché 20 m};

% SUBSECCIÓN 4 (inferior derecha)
% Tolché subsección 4
\draw[fill=tmgray!30, draw=tmgray, line width=1pt] 
  (269.6,0) rectangle (533.2,263.6);
% Área productiva subsección 4
\draw[fill=tmgreen!40, draw=tmgreen!80, line width=1.5pt] 
  (289.6,20) rectangle (513.2,243.6);
\node[font=\Large\bfseries] at (401.4,150) {SUB 4};
\node[font=\small] at (401.4,135) {5 ha productivas};
\node[font=\small] at (401.4,120) {223.6 × 223.6 m};
\node[font=\tiny, text=tmgray] at (401.4,255) {tolché 20 m};

% Camino vertical (6 m)
\draw[fill=tmyellow!30, draw=tmorange, line width=1.5pt] 
  (263.6,0) rectangle (269.6,533.2);
\node[font=\small, rotate=90] at (266.6,266.6) {CAMINO 6 m};

% Camino horizontal (6 m)
\draw[fill=tmyellow!30, draw=tmorange, line width=1.5pt] 
  (0,263.6) rectangle (533.2,269.6);
\node[font=\small] at (266.6,266.6) {CAMINO 6 m};

% Dimensiones externas
\draw[{Latex}-{Latex}, line width=1pt] (0,-25) -- (533.2,-25);
\node[font=\small, below] at (266.6,-25) {533.2 m};

\draw[{Latex}-{Latex}, line width=1pt] (-25,0) -- (-25,533.2);
\node[font=\small, rotate=90, above] at (-25,266.6) {533.2 m};

\end{tikzpicture}

\vspace{0.5cm}
\textbf{LAYOUT 20 HA CON TOLCHÉS INDIVIDUALES}\\
\textit{Área total: 28.43 ha (+42.2\%)}\\
\textit{Cada subsección protegida individualmente}

\vspace{0.3cm}
\begin{tabular}{lll}
\textbullet\ Tolché 20 m (gris) & \textbullet\ Área productiva 5 ha (verde) & \textbullet\ Caminos 6 m (amarillo) \\
\end{tabular}

\caption{Distribución Espacial: 4 Subsecciones con Tolchés Perimetrales Individuales + Caminos de 6 m}
\label{fig:layout_tolches}
\end{figure}

\subsection{Implicaciones para Costos de Infraestructura}

El incremento del 42.2\% en superficie total (20 ha → 28.43 ha) afecta los siguientes rubros:

\begin{enumerate}
  \item \textbf{Desmonte con FAE:} Se debe desmontar toda el área total (tolchés incluidos)
  \begin{itemize}
    \item Área a desmontar: 28.43 ha (vs 20 ha productivas)
    \item Costo adicional: 8.43 ha × \$24,700/ha = \textbf{+\$208,221}
    \item Tiempo adicional: 8.43 ha ÷ 0.8 ha/día = +10.5 días por subsección
    \item \textbf{Nuevo costo total desmonte:} 28.43 ha × \$24,700 = \textbf{\$702,221}
  \end{itemize}

  \item \textbf{Excavación:} Solo se excavan las 20 ha productivas (tolchés NO requieren pocetas)
  \begin{itemize}
    \item Área excavada: 20 ha (sin cambio)
    \item Costo excavación: \textbf{Sin cambio} (\$5,036,000 para 20 ha)
    \item Los tolchés permanecen como zonas verdes de protección
  \end{itemize}

  \item \textbf{Cerca perimetral:} Protección del perímetro externo total
  \begin{itemize}
    \item Perímetro: 4 × 533.2 m = 2,132.8 m
    \item Costo cerca viva (especies nativas) o malla ciclónica: ~\$150/m
    \item \textbf{Costo cercado: +\$319,920}
  \end{itemize}

  \item \textbf{Caminos internos:} Nivelación y compactación de cruz central
  \begin{itemize}
    \item Área caminos: 0.64 ha = 6,362 m²
    \item Nivelación + base granular + compactación: ~\$80/m²
    \item \textbf{Costo caminos: +\$508,960}
  \end{itemize}

  \item \textbf{Sistema de riego:} Solo para áreas productivas (20 ha)
  \begin{itemize}
    \item Tolchés: vegetación nativa sin riego (captación pluvial)
    \item Caminos: drenaje natural, sin riego
    \item Costo riego: \textbf{Sin cambio} (\$900,000 para 20 ha)
  \end{itemize}

\end{enumerate}

\textbf{Resumen de costos adicionales por layout con tolchés individuales:}
\begin{table}[h]
\centering
\begin{tabular}{@{}lrr@{}}
\toprule
\textbf{Concepto} & \textbf{Costo Base} & \textbf{Incremento Tolchés} \\
\midrule
Desmonte (FAE) & \$494,000 (20 ha) & +\$208,221 → \$702,221 \\
Excavación & \$5,036,000 (20 ha) & Sin cambio \\
Cercado perimetral & \$304,320 (25.73 ha) & +\$15,600 → \$319,920 \\
Caminos internos & \$0 (base) & +\$508,960 → \$508,960 \\
\midrule
\textbf{TOTAL adicional} & — & \textbf{+\$732,781} \\
\bottomrule
\end{tabular}
\caption{Incremento de Costos por Diseño con Tolchés Individuales (vs diseño sin protección)}
\end{table}

\textbf{Inversión total ajustada:}
\begin{itemize}
  \item Base infraestructura (20 ha sin tolchés): \$13,791,750
  \item Incremento por tolchés + caminos: +\$732,781
  \item \textbf{TOTAL con protección perimetral: \$14,524,531}
  \item Incremento porcentual: +5.3\% sobre inversión base
\end{itemize}

\subsection{Beneficios del Layout con Tolchés Individuales}

A pesar del incremento del 42.2\% en superficie total, este diseño ofrece ventajas operativas y productivas significativas:

\begin{enumerate}
  \item \textbf{Protección individual por subsección:}
  \begin{itemize}
    \item Cada 5 ha protegidas contra fauna (venados, pecaríes, tejones, agutíes)
    \item Barrera cortafuego de 20 m reduce riesgo de incendios catastróficos
    \item Aislamiento sanitario entre subsecciones (control de plagas/enfermedades)
  \end{itemize}

  \item \textbf{Acceso mecanizado optimizado:}
  \begin{itemize}
    \item Caminos de 6 m permiten tránsito bidireccional de CAT 420F
    \item Cruz central conecta las 4 subsecciones sin atravesar áreas productivas
    \item Reduce compactación de suelo en zonas de cultivo
  \end{itemize}

  \item \textbf{Microclima mejorado:}
  \begin{itemize}
    \item Vegetación nativa en tolchés reduce velocidad del viento
    \item Menor evapotranspiración en áreas productivas (+15-20\% eficiencia hídrica)
    \item Sombreado parcial en bordes reduce estrés térmico
  \end{itemize}

  \item \textbf{Manejo independiente por subsección:}
  \begin{itemize}
    \item Posibilidad de rotaciones diferenciadas (maíz-frijol-calabaza)
    \item Siembra/cosecha escalonada facilita logística
    \item Aislamiento permite ensayos de nuevas variedades sin contaminación cruzada
  \end{itemize}

  \item \textbf{Biodiversidad funcional:}
  \begin{itemize}
    \item Tolchés con vegetación nativa albergan polinizadores (abejas, abejorros)
    \item Fauna benéfica (aves insectívoras) controla plagas naturalmente
    \item Cumplimiento de certificación orgánica (requisitos de biodiversidad)
  \end{itemize}

  \item \textbf{Escalabilidad y expansión:}
  \begin{itemize}
    \item Patrón modular replicable para 100-250 ha
    \item Caminos internos sirven como eje para expansión futura
    \item Tolchés actúan como "columna vertebral" de conectividad ecológica
  \end{itemize}

  \item \textbf{Resiliencia ante eventos climáticos:}
  \begin{itemize}
    \item Tolchés con vegetación absorben escorrentía (reducen erosión)
    \item Drenaje natural por caminos evita encharcamientos
    \item Diversificación espacial reduce riesgo de pérdida total por huracanes
  \end{itemize}
\end{enumerate}

\textbf{Retorno de inversión del incremento (+\$732,781):}
\begin{itemize}
  \item Reducción pérdidas por fauna: 10-15\% del valor cosecha anual → \$180,000-\$270,000/año
  \item Incremento eficiencia hídrica: ahorro en bombeo → \$25,000/año
  \item Mejora rendimientos por microclima: +5\% en productividad → \$90,000/año
  \item \textbf{Recuperación estimada: 2-3 años} (vs 4+ años sin protección)
\end{itemize}

\textbf{Estándar industrial aplicado:}
\begin{itemize}
  \item Ancho caminos 6 m: Norma para CAT 420F (2.4 m) + tránsito bidireccional
  \item Tolché 20 m: Estándar SADER para zonas con presión de fauna silvestre
  \item Configuración 2×2: Óptima para 20 ha (balance entre protección y costo)
\end{itemize}

\textbf{Nota:} El diseño asume terreno cuadrado ideal. Ajustes serán necesarios según topografía y forma real del predio disponible. En terrenos irregulares, se recomienda mantener el ancho de tolchés (20 m) y caminos (6 m) pero adaptar la geometría de las subsecciones productivas.

\subsection{Nota sobre Arrendamiento Ejidal}

El proyecto contempla arrendamiento de terrenos a largo plazo con el ejido de Timucuy, Yucatán. El incremento del 42.2\% en superficie total (de 20 ha productivas a 28.43 ha totales) debido a tolchés y caminos internos \textbf{NO representa una limitante significativa} para el modelo de arrendamiento ejidal.

\textbf{Aspectos clave:}
\begin{itemize}
  \item Superficie ejidal disponible: > 3,000 ha (Fase 1 requiere solo 28.43 ha = 0.9\% del ejido)
  \item Costo adicional estimado: \$25,000-\$85,000/año según esquema de renta negociado
  \item Beneficios ambientales para el ejido: Tolchés con vegetación nativa conservan biodiversidad, reducen erosión y actúan como cortafuegos
  \item Infraestructura compartida: Caminos internos pueden tener uso ejidal
\end{itemize}

\textbf{Para análisis completo de viabilidad de arrendamiento, estrategia de negociación, cláusulas contractuales y planificación de expansión futura, consultar:} \textit{Reporte de Proyección Financiera 5 Años, Sección: Consideraciones de Arrendamiento Ejidal y Layout del Proyecto.}
